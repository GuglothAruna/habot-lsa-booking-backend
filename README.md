...
The high-level backend architecture and request flow are documented in [ARCHITECTURE.md](ARCHITECTURE.md).
...
python manage.py runserver and keeping this and also artictecture file
